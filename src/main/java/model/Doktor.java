...
public class Doktor extends Mahasiswa {
    ...
    public Doktor(String judulPenelitianDisertasi, int nilaiSidang1, int nilaiSidang2, int nilaiSidang3, int nim, String jurusan, String nama, String alamat, String ttl, int telepon) {
    ...
    public String toString() {
        return "Doktor{" + "nama=" + nama + ", alamat=" + alamat + 
                ", ttl=" + ttl + ", telepon=" + telepon + "nim=" + nim + 
                ", jurusan=" + jurusan + "judulPenelitianDisertasi=" 
                + judulPenelitianDisertasi + ", nilaiSidang1=" + nilaiSidang1 
                + ", nilaiSidang2=" + nilaiSidang2 + ", nilaiSidang3=" 
                + nilaiSidang3 + '}';
    }
